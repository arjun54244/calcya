...
const EmiCalc = () => {
  ...
  return (
    <div className={`${error ? "lg:flex lg:justify-center" : ""}`}>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-8">
                    ...
                    <input
                      ...
                      type="number"
                      name="amount"
                      placeholder="Monthly Amount* (in Rupees)"
                      className="border-stroke w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
                    />
                    <p
                      className={`text-sm ${errorAmount ? "text-red-700" : "text-body-color"}`}
                    >
                      Range between ₹2,500 - ₹10,00,00,000
                    </p>
                  </div>
                  <div className="mb-8">
                    <label
                    ...
                    />
                    <p
                      className={`text-sm ${errorReturn ? "text-red-700" : "text-body-color"}`}
                    >
                      Range between 2% - 50%
                    </p>
                  </div>
                  <div className="mb-8">
                    ...
                    />
                    <p
                      className={`text-sm ${errorTime ? "text-red-700" : "text-body-color"}`}
                    >
                      Range between 0 - 75
                    </p>
                  </div>
      ...
      {error && (
        <EmiResult amount={amount} returnRate={returnRate} time={time} />
      )}
    </div>
  );
};
