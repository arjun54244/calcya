...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-16 pt-[120px] md:pb-[120px] md:pt-[150px] xl:pb-[60px] xl:pt-[120px] 2xl:pb-[200px] 2xl:pt-[210px]"
      >
        {isClient && (
          <div className="container">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform flex-wrap bg-white bg-opacity-60 p-3 text-center">
                ...
                <div className="mx-auto max-w-[800px] text-center">
                  ...
                  <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                    <Link
                      ...
                      className="rounded-sm bg-[#321f05] px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-[#321f05]/80"
                    >
                      Call Us
                    </Link>
                    <Link
